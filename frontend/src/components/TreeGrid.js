        ...
        renders.push(
          ...
          >
            {levels[levelIndex].fields.map(function (field, index) {
              ...
              if (index === 0) {
                return (
                  <td key={'value-' + index} className="d-flex align-middle text-start icon-sm">
                ...
                return (
                  <td key={'value-' + index} className="align-middle">
        ...
        <thead>
          ...
          >
            {levels[0].fields.map(function (field, index) {
              return (
                <th key={'field-' + index} className={getCssAlignmentTitle(field.alignment)}>
