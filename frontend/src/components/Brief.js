...
const Brief = function ({ fieldsDisposition, fieldsSize, fields }) {
  switch (fieldsDisposition) {
    ...
    default: {
      ...
      switch (fieldsDisposition) {
        case 'start': {
          className = "wit-brief d-flex";
          break;
        }
        case 'center': {
          className = 'wit-brief d-flex justify-content-center';
          break;
        }
        case 'end': {
          className = 'wit-brief d-flex justify-content-end';
          break;
        }
        case 'spaces-between': {
          className = 'wit-brief d-flex justify-content-between';
          break;
        }
        case 'spaces-around': {
          className = 'wit-brief d-flex justify-content-around';
          break;
        }
        default: {
