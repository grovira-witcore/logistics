    ...
    <div className="container">
      <div className="row" style={{ padding: '40px', width: '100%' }}>
        <div className="col-6 text-center text-default" style={{ paddingTop: '20px' }}>
          ...
          <div style={{ paddingTop: '10px', fontFamily: 'Inter-Bold', fontSize: '20px' }}><ErrorBox /></div>
          {error.status ?
            <div style={{ paddingTop: '20px', fontFamily: 'Inter-Regular', fontSize: '20px' }}>{words.errorCode + ': ' + error.status.toString()}</div> :
            null
          }
