...
const BookingsBody = ReactRouterDOM.withRouter(function () {
  ...
  const [dataSourceShipperId, setDataSourceShipperId] = React.useState([]);
  const [dataSourceContractId, setDataSourceContractId] = React.useState([]);

  React.useEffect(() => {
    fetchDataSourceShipperId();
    fetchDataSourceContractId();
  }, []);
  ...
  const fetchDataSourceShipperId = async function () {
    ...
    setDataSourceShipperId(records.map((record) => [record.shipperId, record.name]));
  }
  ...
  const fetchDataSourceContractId = async function () {
    ...
    setDataSourceContractId(records.map((record) => [record.contractId, record.code]));
  }
            ...
            filters={[
              {
                label: words.shipper,
                variant: 'option',
                dataSource: dataSourceShipperId
              },
              {
                label: words.contract,
                variant: 'option',
                dataSource: dataSourceContractId
              },
              {
                label: words.status,
                variant: 'option',
